...
export function ZoomableImage({
  ...
  return (
    <>
      ...
      >
        {children}
        {/* Persistent corner cue: the zoom affordance must read before hover.
            Same quiet chip language as the carousels' enlarge buttons; it
            crossfades into the labeled pill on hover. */}
        <span
          aria-hidden
          className="pointer-events-none absolute bottom-3 right-3 inline-flex items-center justify-center w-8 h-8 rounded-full bg-black/50 backdrop-blur-sm text-white opacity-60 group-hover:opacity-0 transition-opacity duration-200"
        >

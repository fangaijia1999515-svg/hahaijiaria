...
- **小牌**:
  ...
  - `COURT_SCENES`(她的第三条 law,2026-07-21):**宫廷牌不许"同一张图换符号"** — 16 张各自独立场景 = 身份气质(侍从幼芽/骑士风/王后花/国王树)× 花色元素:圣杯=杯里盛月/渡湖之风/湖心莲座/静水深流(树的倒影);权杖=新芽初生/彗尾疾行/满枝盛放/根深叶茂(金杖成树);星币=顶起种子/长路稳行/金心之花/树下有靠;宝剑=初次起飞/破雾俯冲/花与羽并肩/风止月明(大月+静羽)。改哪张 = `COURT_SCENES[花色][身份].render`。
  - 大牌撞车预防:大牌不许长小牌花色符号的脸(节制曾因两只杯子撞脸圣杯被她抓出,已改成"两弯月各垂一线水")。新场景先查四个 Glyph 造型再动笔。
